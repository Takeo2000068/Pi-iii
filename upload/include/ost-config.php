...
define('SECRET_SALT','9OJyWb6l7J1UEDv04zfG0lFBwP4RekVy');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','takeo@tanuki.com.br');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','mysql.univesp-pi.com.br');
define('DBNAME','univesppi09');
define('DBUSER','univesppi09');
define('DBPASS','univesppi09');

# Table prefix
define('TABLE_PREFIX','uost_');
